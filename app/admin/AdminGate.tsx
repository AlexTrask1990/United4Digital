      ...
      {authState === "login" && (
        <div className="container mx-auto max-w-md rounded-custom border border-primary/10 bg-white p-8 shadow-sm laptop:p-10">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link
              href="/"
              className="text-sm font-bold text-secondary transition-colors hover:opacity-80"
            >
              Site
            </Link>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleLogin}>
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full rounded-custom border border-primary/15 px-4 py-3 text-primary outline-none focus:border-secondary"
            ...
            <button
              ...
              className="w-full rounded-custom bg-secondary px-6 py-3 text-sm font-bold text-white transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
