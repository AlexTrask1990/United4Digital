  ...
  return (
    <div className="container mx-auto max-w-3xl rounded-custom border border-primary/10 bg-white p-8 shadow-sm laptop:p-10">
      <div className="flex flex-col gap-3 laptop:flex-row laptop:items-center laptop:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-primary">Ads files Admin</h1>
        ...
        <button
          ...
          className="text-sm font-bold text-secondary transition-colors hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Log out
        </button>
      </div>
      ...
      {isSaving && (
        <div
          className="mt-6 rounded-custom border border-primary/20 bg-primary/5 px-4 py-3 text-sm font-semibold text-primary"
          role="status"
          aria-live="polite"
        >
      ...
      {errorMessage && (
        <div
          className="mt-6 rounded-custom border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm font-semibold text-red-600"
          role="alert"
        >
          {errorMessage}
        </div>
      ...
      <form className="mt-8 space-y-6" onSubmit={saveConfig}>
        <label className="block">
          ...
          <select
            ...
            disabled={isFormLocked}
            className="mt-2 w-full rounded-custom border border-primary/15 bg-white px-4 py-3 text-primary outline-none focus:border-secondary disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={14}
            disabled={isFormLocked}
            className="mt-2 w-full rounded-custom border border-primary/15 px-4 py-3 font-mono text-sm text-primary outline-none focus:border-secondary disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <button
          type="submit"
          disabled={isFormLocked}
          className="rounded-custom bg-secondary px-6 py-3 text-sm font-bold text-white transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
        >
