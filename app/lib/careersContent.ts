...
export const careerListings: CareerListing[] = [
  {
    ...
    sections: [
      ...
      },
      {
        title: "Nice to have",
        description:
          "Not required, but any of the following competencies would be a strong plus. These competencies are not core requirements. The primary responsibility of the role remains designing, animating, polishing, and implementing the game UI in Unity.",
        items: [],
      },
      {
