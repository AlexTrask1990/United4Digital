      ...
      <div className="w-11/12">
        ...
        <Container>
          <div className="flex flex-col items-center widescreen:items-start pt-14 laptop:pt-0 widescreen:flex-row justify-between">
            <Form />
            <div className="order-1 min-h-[360px] max-w-[1280px] overflow-hidden widescreen:order-2 laptop:min-h-[880px] pb-4 pt-4 tablet:ml-4 laptop:pt-0 widescreen:pb-0">
              <ContactUsLottie />
            </div>
          </div>
        </Container>
