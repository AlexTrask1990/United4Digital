      ...
      <div className="w-11/12">
        ...
        <Container>
          <div className="flex flex-col laptop:flex-row pt-14 laptop:pt-0 items-center laptop:justify-between">
            ...
            <div className="w-auto h-auto min-h-[320px] max-w-[730px] max-h-[406px] overflow-hidden laptop:min-h-[450px]">
              <Image
          ...
          <div className="flex laptop:justify-end items-center flex-col laptop:flex-row-reverse pt-28">
            <div className="order-1 min-h-[320px] max-w-[737px] overflow-hidden laptop:order-2 laptop:min-h-[580px]">
              <SocialMediaLottie />
            </div>
