      ...
      <div className="w-11/12">
        ...
        <Container>
          <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse">
            <div className="order-2 min-h-[200px] max-w-[1040px] overflow-hidden laptop:order-1 laptop:min-h-[520px]">
              <MonetizationGraph />
            </div>
          ...
          <div className="flex laptop:justify-between flex-col items-center laptop:flex-row-reverse pt-28">
            <div className="order-2 min-h-[200px] max-w-[1010px] max-h-[490px] overflow-hidden laptop:order-2 laptop:min-h-[490px]">
          ...
          <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse pt-28">
            <div className="order-2 min-h-[200px] max-w-[1010px] overflow-hidden laptop:order-1 laptop:min-h-[490px]">
          ...
          <div className="flex laptop:justify-end items-center flex-col laptop:flex-row-reverse pt-28">
            <div className="order-2 min-h-[200px] max-w-[730px] max-h-[460px] overflow-hidden laptop:min-h-[460px]">
              <PublishersLottie />
            </div>
